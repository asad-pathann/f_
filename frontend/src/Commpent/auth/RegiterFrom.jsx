...
const RegiterFrom = () => {
  ...
  const { user, userError, userMessage, userLoading, userSuccess } =
  ...
  return (
    <>
      <form className="p-2 mt-0  rounded-md bg-white  ">
        <h4 className="text-2xl text-center font-bold my-1 ">
        ...
        <div className="grid grid-cols-2 gap-2">
          <input
            ...
            type="text"
            placeholder="f_name"
            className="p-2 rounded-md border outline-0 border-gray-400"
          />
          <input
            value={l_name}
            name="l_name"
        ...
        <div className="flex gap-1  items-center my-2  ">
          ...
          <span>
            <AiFillQuestionCircle className="text-gray-400" />
          </span>
        </div>
        ...
        <select
          onChange={handleControll}
          value={pronune}
          className={`p-2 rounded-md border my-3    border-gray-400 w-full  ${
            opencustom ? "block" : "hidden"
          }`}
          name="pronune"
          id=""
        >
        ...
        <input
          ...
          className="w-full border my-2  border-gray-400   rounded-md outline-0 p-2 "
          name="email"
          id=""
        />
