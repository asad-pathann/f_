        ...
        <div className="bg-white sm:h-[350px] w-[100%] rounded-2xl overflow-hidden sm:shadow-sm shadow-gray-400 sm:my-3 my-1">
          <div className="flex sm:flex-col items-center justify-content gap-2 ">
            <img
              ...
              className="sm:h-[200px] object-contain rounded-full sm:rounded-t-2xl sm:rounded-b-none h-[90px] sm:w-[100%] "
              alt=""
            />
            <div className="flex flex-col p-1">
              <p className=" capitalize text-md text-center  font-semibold">
                {f_name}
                {l_name}
              </p>
              ...
              <div className="flex sm:flex-col gap-2">
                ...
                <button className="px-7 py-1  rounded-lg w-full p-1 bg-gray-200 ">
                  Delete
                </button>
              </div>
            </div>
